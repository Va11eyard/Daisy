...
|---|-------|-----------------|------|--------|
| 1 | **Overall pass rate >= 90%** | `python stage1-immediate/run_cross_topic_regression.py --deployment gpu-deployment-v14 --output eval/v14_report.json` | >= 90% | [ ] |
